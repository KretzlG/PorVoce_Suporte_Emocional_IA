...
def build_gemini_prompt(context: PromptContext, therapeutic_approach: PromptType) -> Dict:
    """
    Monta o prompt completo para o modelo Gemini.
    ...
    try:
        ...
        # Bloco de sistema base (pode ser customizado para Gemini)
        ...
        logger.error(f"Erro na construção do prompt Gemini: {e}")
